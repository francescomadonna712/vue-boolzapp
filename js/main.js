        ...
        return{
            ...
            contacts: [
                ...
                },
                {
                    ...
                    messages: [
                        {
                            date: '20/03/2024 16:30:00',
                            message: 'Ciao come stai?',
                            status: 'sent'
                        },
                        {
                            date: '20/03/2024 16:30:55',
                            message: 'Bene grazie! Stasera ci vediamo?',
                            status: 'received'
                        },
                        {
                            date: '20/03/2024 16:35:00',
    ...
    methods: {
        ...
        findFriend() {
            this.contacts.forEach(contact => {
                ...
                const search = this.newSearch.toLowerCase();
                contact.visible = contactName.includes(search);
            });
        },
